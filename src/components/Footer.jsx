      ...
      <div className="w-full px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-serif font-bold text-gray-900">About Us</h3>
            <p className="text-gray-600">
              We're passionate about sharing knowledge and inspiring minds through thoughtful content.
            </p>
          ...
          {/* Quick Links */}
          <div className="space-y-4">
            <h3 className="text-lg font-serif font-bold text-gray-900">Quick Links</h3>
          ...
          {/* Newsletter */}
          <div className="space-y-4">
            <h3 className="text-lg font-serif font-bold text-gray-900">Newsletter</h3>
            <p className="text-gray-600">
